      ...
      {isChannelRules ? (
        <div className="info-page__rules">
          ...
          <section className="info-page__section">
            ...
            <p>
              Чтобы приобрести понравившуюся вещь, добавьте активный адрес в приложении и добавьте товар в корзину.
            </p>
            <p>
              На большую часть товаров мы постарались сделать замеры и также обозначить деффекты на вещах, на которых они есть. Все в одной карточке товара, чтобы вы могли ознакомиться с ней до покупки. Если у вас возникнут вопросы по замерам или дефектам, не стесняйтесь обращаться к нашим администраторам.
            </p>
