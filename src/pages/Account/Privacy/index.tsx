...
const sections: Array<{ title: string; text: string[] }> = [
  {
    ...
    text: [
      "Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных пользователей Telegram Mini App AES ISLAND https://t.me/aesisland_bot, а также меры по обеспечению безопасности персональных данных, предпринимаемые Иванов Иван Иванович (далее — Оператор).",
      "Использование Сервиса означает согласие Пользователя с настоящей Политикой.",
    ],
  },
  {
    title: "2. Оператор",
    text: ["Оператором персональных данных является Иванов Иван Иванович.", "Контакты для связи: Telegram: @aesadmin1, @aesadminmsk."],
  },
  {
